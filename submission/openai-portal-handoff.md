...
**Versión preparada:** Nuvetio 0.2.1
...
Usar la descripción corta y larga de `listing.es.md`, los tres starter prompts de `starter-prompts.es.json` y los casos de `test-cases.json`. La release de referencia es <https://github.com/Mroa29/Nuvetio/releases/tag/v0.2.1>.
