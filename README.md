...
1. Descarga `Nuvetio-0.2.1.zip` desde la release y descomprímelo en Descargas.
...
El repositorio contiene el manifiesto público, las skills estáticas, los instaladores, el sitio de documentación y las comprobaciones de distribución de Nuvetio. La versión 0.2.1 no habilita todavía backend, telemetría, conectores, MCP, cuentas de usuario ni aprendizaje compartido.
